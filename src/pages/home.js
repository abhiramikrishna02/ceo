...
const communityBenefits = [
  ...
  { id:"02", eyebrow:"Mentorship & Growth", headline:"The Mentor\nAdvantage.", sub:"Access wisdom that compresses decades into decisive moments.", detail:"CEO Square pairs you with battle-tested leaders and executive mentors who offer personalized coaching, strategic guidance, and mastermind-driven sessions.", tags:["Personalized Coaching","Mastermind Groups","Executive Access"], stat:{ value:"2000+", label:"Founders and CEOs engaged in mentorship." }, accent:"Proximity to greatness accelerates everything." },
